            ...
            <div class="col-10 pt-4">
                ...
                <input type="hidden" name="student_id" value="<?php echo $student['id']?>">
                        ...
                        <div class="col-sm-10 d-flex">
                            <div class="form-check">
                                <input class="form-check-input <?php if (!empty($hostel_error)) {
                                                                    echo 'is-invalid';
                                                                } ?>" type="radio" name="hostel" id="gridRadios1" value="yes" required <?php if($student['hostel'] == 'yes'){echo 'checked';}else{'';} ?> />
                            ...
                            <div class="form-check">
                                <input class="form-check-input <?php if (!empty($hostel_error)) {
                                                                    echo 'is-invalid';
                                                                } ?>" type="radio" name="hostel" id="gridRadios2" value="no" required <?php if($student['hostel'] == 'no'){echo 'checked';}else{'';} ?>/>
                    ...
                    <div class="col-md-12 d-md-flex justify-content-between required">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name='subject[]' value="Cyber security" id="cybersecurity" onclick="return myfun()" <?php if($student['subject'] == 'Cyber security'){echo 'checked';}else{'';} ?> />
                            <label class="form-check-label" for="cybersecurity">
                                Cyber security
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name='subject[]' value="Artificial intelligence" id="artificialintelligence" onclick="return myfun()" <?php if($student['subject'] == 'Artificial intelligence'){echo 'checked';}else{'';} ?>/>
                            <label class="form-check-label" for="artificialintelligence">
                                Artificial intelligence
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name='subject[]' value="IOT" id="iot" onclick="return myfun()" <?php if($student['subject'] == 'IOT'){echo 'checked';}else{'';} ?> />
                            <label class="form-check-label" for="io">
                                IOT
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name='subject[]' value="Robotics" id="robotics" onclick="return myfun()" <?php if($student['subject'] == 'Robotics'){echo 'checked';}else{'';} ?>/>
                            <label class="form-check-label" for="robotics">
                                Robotics
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name='subject[]' value="Block chain" id="blockchain" onclick="return myfun()" <?php if($student['subject'] == 'Block chain'){echo 'checked';}else{'';} ?>/>
