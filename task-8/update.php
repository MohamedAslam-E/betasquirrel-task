            ...
            <div class="col-10 pt-4">
                ...
                <input type="hidden" name="student_id" value="<?php echo $student['id']?>">
                    ...
                    <div class="col-md-12 d-md-flex justify-content-between required">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name='subject[]' value="Cyber security" id="cybersecurity" onclick="return myfun()" <?php if(in_array('Cyber security',$sub)){echo 'checked';}else{'';} ?> />
                            <label class="form-check-label" for="cybersecurity">
                                Cyber security
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name='subject[]' value="Artificial intelligence" id="artificialintelligence" onclick="return myfun()" <?php if(in_array('Artificial intelligence',$sub)){echo 'checked';}else{'';} ?>/>
                            <label class="form-check-label" for="artificialintelligence">
                                Artificial intelligence
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name='subject[]' value="IOT" id="iot" onclick="return myfun()" <?php if(in_array('IOT',$sub)){echo 'checked';}else{'';} ?> />
                            <label class="form-check-label" for="io">
                                IOT
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name='subject[]' value="Robotics" id="robotics" onclick="return myfun()" <?php if(in_array('Robotics',$sub)){echo 'checked';}else{'';} ?>/>
                            <label class="form-check-label" for="robotics">
                                Robotics
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name='subject[]' value="Block chain" id="blockchain" onclick="return myfun()" <?php if(in_array('Block chain',$sub)){echo 'checked';}else{'';} ?>/>
